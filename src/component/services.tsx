          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto mx-4 shadow-2xl border-2 border-blue-100">
            ...
            <div className="p-8 text-gray-900 bg-white">
              <div className="mb-8">
                ...
                <p className="text-gray-700 mb-4 leading-7">{selectedService.howItWorks.description}</p>
                <ul className="space-y-2">
                  {selectedService.howItWorks.features.map((feature, index) => (
                    <li key={index} className="text-gray-700 leading-7">
                      • {feature}
                    </li>
                  ))}
                </ul>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {selectedService.metrics.map((metric, index) => (
                  <div key={index} className="bg-blue-50 border border-blue-100 rounded-lg p-4 text-center">
                    ...
                    <div className="text-sm text-gray-600 leading-7">{metric.label}</div>
                  </div>
                ))}
              </div>
                ...
                <div className="space-y-4">
                  {selectedService.implementationSteps.map((step, index) => (
                    <div key={index} className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1 leading-7">{step.title}</h4>
                        <p className="text-gray-700 text-sm leading-7">{step.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="mt-8 p-4 bg-blue-50 border border-blue-100 rounded-lg">
                ...
                <ul className="text-sm text-gray-700 space-y-1 leading-7">
