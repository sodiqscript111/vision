...
export const services: Service[] = [
    ...
    // --- 6. CORE SERVICE: CENTRALIZED CONTROL ---
    {
        id: "centralized-control",
        title: "Centralized Control Platform",
        description:
            "A unified, cloud-based dashboard that aggregates data from all your smart systems—computer vision, ESL, RFID, facial recognition—into a single pane of glass. Gain complete visibility with real-time monitoring and AI-powered analytics[cite: 230, 231].",
        advantages: [
            "Single Point of Control: No more juggling multiple systems [cite: 293]",
            "Real-time Monitoring: Know what's happening right now [cite: 293]",
            "Automated Alerts: Prioritized notifications for critical events [cite: 293]",
            "Multi-location Management: Scale from one to hundreds of sites [cite: 294]",
        ],
        considerations: [
        ...
        targetIndustries: ["Retail Chains", "Logistics", "Enterprise Security", "Smart Buildings"],
        metrics: [
        ...
        howItWorks: {
            description:
                "The platform ingests data via APIs from connected systems, normalizes it, and processes it through a stream processing engine. Machine learning models identify anomalies and insights, which are visualized on customizable dashboards [cite: 233-236].",
            features: [
                "Data Ingestion & Normalization [cite: 233]",
                "Real-time Stream Processing [cite: 234]",
                "AI Analytics for pattern recognition [cite: 234]",
                "Automation Engine for rule-based triggers [cite: 235]",
                "Role-Based Access Control [cite: 240]",
                "Mobile App Integration [cite: 240]",
            ],
        },
        implementationSteps: [
            {
                ...
                description: "APIs and connectors pull data from all integrated systems [cite: 233]",
            },
            {
                number: 2,
                title: "Data Normalization",
                description: "Different data formats standardized into common schema [cite: 233]",
            },
            {
                number: 3,
                title: "Real-time Processing",
                description: "Stream processing engine handles live data feeds [cite: 234]",
            },
            {
                number: 4,
                title: "AI Analytics & Visualization",
                description: "ML models identify insights displayed on customizable dashboards [cite: 234, 235]",
            },
            {
                number: 5,
                title: "Automation & Reporting",
                description: "Rules trigger actions and scheduled reports are delivered [cite: 235, 236]",
            },
        ],
    },
]